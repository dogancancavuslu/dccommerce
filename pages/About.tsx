      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 mb-24">
          <div className="lg:col-span-2">
            <p className="text-xl text-[#5B6C7D] leading-relaxed mb-8">
              DC Commerce started in 2024 with a simple idea: help businesses navigate the digital world and global markets without the complexity.
            </p>
            <p className="text-lg text-[#5B6C7D] leading-relaxed mb-8">
              We're a small team based in the UK, passionate about technology and international trade. Our founders bring together expertise in software development, e-commerce, and import-export operations. We believe that great things come from small, focused teams who truly care about their clients.
            </p>
            <p className="text-lg text-[#5B6C7D] leading-relaxed mb-8">
              Being a startup means we're hungry, agile, and committed. We don't have layers of bureaucracy — when you work with us, you work directly with the people building your solutions.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-[#f8fafc] border border-[#E8ECEF] p-8 rounded-lg">
            <h4 className="text-xl font-bold text-[#1A2B4A] mb-4">🚀 Startup Spirit</h4>
            <p className="text-[#5B6C7D] leading-relaxed">
              We move fast, think creatively, and aren't afraid to challenge the status quo. Every project is an opportunity to innovate.
            </p>
          </div>
          <div className="bg-[#f8fafc] border border-[#E8ECEF] p-8 rounded-lg">
